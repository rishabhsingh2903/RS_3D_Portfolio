...
const experiences = [
  {
    ...
    company_name: "RoomieHub",
    icon: RoomieHub,
    iconBg: "#383E56",
    date: "Jun 2024 - Present",
    points: [
      "Developed: a user-friendly mobile application with React Native, driving a 25% increase in user engagement and a 15% reduction in bounce rates.",
      "Built: dynamic swiping and messaging components, improving user retention by 30% and increasing daily active users by 20%.",
      "Deployed: solutions for application stability, resolving cyclic rendering and dependency issues, resulting in a 50% reduction in bug reports.",
    ],
  },
  {
...
const projects = [
  ...
  },
  {
    ...
    image: CabAnalysis,
    source_code_link:
      "https://public.tableau.com/app/profile/rishabh.singh6026/viz/CabAnalysis_16823004881390/Dashboard1",
  },
];
